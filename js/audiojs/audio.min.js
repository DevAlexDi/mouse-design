        ...
        settings: {
            ...
            updatePlayhead: function (b) {
                ...
                var a = this.settings.createPlayer,
                    c = j(a.scrubberClass, this.wrapper);
                //мой код
                var duration_1 = j(a.durationClass, this.wrapper);
                
                
                
                var cc = Math.floor(this.duration / 60),
                dd = Math.floor(this.duration % 60);
                
                var time_expression = this.duration - (this.duration * b);
                
                var minutes = Math.floor(time_expression / 60);
                var seconds = Math.floor(time_expression % 60);
                ...
                if(minutes >= 0 && seconds >= 0){
                    duration_1.innerHTML = (minutes < 10 ? "0" : "") + minutes + ":" + (seconds < 10 ? "0" : "") + seconds; 
                }
                //console.log('общее время песни : минуты ' + cc + " секунды "+dd);
                //console.log('прошло : минуты ' + b + " секунды "+c);
